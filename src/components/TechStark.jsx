...
export default function Technologies() {
  return (
    <section style={{ padding: '0 6vw 64px', background: '#f8fafc' }}>
      ...
      >
        <div style={{ marginBottom: 32, textAlign: 'center' }}>
          ...
          <h2 style={{ fontSize: 36, fontWeight: 900, letterSpacing: '0.05em', color: '#6C63FF', textTransform: 'uppercase' }}>Technologies We Use</h2>
          <p style={{ marginTop: 12, color: '#64748b', fontWeight: 500, fontSize: 18 }}>
